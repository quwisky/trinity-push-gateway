...
This decision supersedes ADR 0013 only where it selected the prior schema validator. ADR 0013's focused-dependency policy, `jose` ownership of PKCS#8 import and RS256 signing, direct FCM HTTP v1 delivery, gateway-owned OAuth, caching, retry, payload, and error-classification behavior, and bundle enforcement remain in force.
